# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-10-01 08:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_creatDate', models.DateTimeField(default=datetime.datetime.now)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.Permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': '\u63d0\u5355\u4eba\u7528\u6237\u4fe1\u606f\u8868',
                'verbose_name_plural': '\u63d0\u5355\u4eba\u7528\u6237\u4fe1\u606f\u8868',
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Device_version', models.SmallIntegerField(choices=[(0, 'ARM'), (1, 'Dorado5000'), (2, 'Dorado6000')], verbose_name='\u8bbe\u5907\u7248\u672c')),
            ],
            options={
                'verbose_name': '\u8bbe\u5907\u8868',
